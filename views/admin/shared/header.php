...
<head>
    ...
    <!-- Icons --> <script src="../../assets/vendors/js/jquery.min.js"></script>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    <header class="app-header navbar">
        ...
        <a class="navbar"  id ="ufps"href="#">UFPS</a>
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="./views/assets/vendors/img/avatars/6.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                    <span class="d-md-down-none"><?php echo $_SESSION['user'] ?> </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="dropdown-header text-center">
