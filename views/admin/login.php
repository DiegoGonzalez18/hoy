...
<head>
  ...
  <!-- Icons -->
  <link href="../assets/vendors/css/font-awesome.min.css" type="text/css" rel="stylesheet">
  <link href="../assets/vendors/css/simple-line-icons.min.css"type="text/css" rel="stylesheet"">

  <!-- Main styles for this application -->
  <link href="../assets/vendors/css/style.css" type="text/css" rel="stylesheet">
...
$.ajax({
  type:  'POST', 
                ...
                url:   'login2/', //archivo que recibe la peticion
                //método de envio
                beforeSend: function () {
                  $("#alerta").remove()     
